...
class Track(Base):
    ...
    global_feature_data = Column(JSON, nullable=True)
    ...
    reference_uploads = relationship(
        "UserUpload", foreign_keys="UserUpload.reference_track_id"
    )
...
class TrainingExample(Base):
    ...
    stage = Column(
        String, nullable=True, default="Half Finished"
