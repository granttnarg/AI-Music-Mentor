...
if __name__ == "__main__":
        ...
        try:
            ...
            with open(json_file, 'r', encoding='utf-8') as f:
                ...
                upload_id = ops.add_user_upload(
                    ...
                    input_duration=audio_data['processed']['global_feature_data']['metadata']['duration'],
                    input_sample_rate=audio_data['processed']['global_feature_data']['metadata']['sample_rate'],
    ...
    if track:
        ...
        similar_tracks = ops.find_similar_tracks(track['embedding'], limit=5, threshold=0.03)
