    ...
    try:
        ...
        for track in tracks:
            try:
                ...
                print(
                    f"   Actual duration: {actual_duration:.1f}s (DB had: {track.duration:.1f}s)"
                )
                ...
                if track.raw_predictions and track.raw_confidence_scores:
                    try:
                        ...
                        print(
                            f"   Created {len(arrangement_blocks)} arrangement blocks with proper timing"
                        )
